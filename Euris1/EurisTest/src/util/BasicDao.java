 ...
 * Stabilita la connessione è in grado di eseguire query e restituire
 * in caso di necessità una lista di mappe o una mappa che descrive un resultset.
...
public abstract class BasicDao {
	...
	/**
	 * Lista contenente mappe che descrivono delle entità nella persistenza
	...
	public List<Map<String, String>> getAll(String sql, Object...conditions) {
		...
		// Ho usato Object perchè voglio essere il più generico possibile
